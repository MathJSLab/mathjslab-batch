...
const getInitialLocale = (): Locale => {
  ...
  return normalizeLocale(params.get('lang') || globalThis.localStorage.getItem('mathjslab-batch:locale') || globalThis.navigator.language);
};
...
class I18n extends EventTarget {
  ...
  public setLocale(locale?: string): void {
    ...
    globalThis.localStorage.setItem('mathjslab-batch:locale', nextLocale);
